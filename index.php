...
$allMessageStatement = $database->query('SELECT messages.*, users.nickname, users.color FROM messages INNER JOIN users WHERE users.id = messages.user_id ORDER BY messages.created_at LIMIT 30');
